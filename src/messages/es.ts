...
export const messages: Messages = {
  ...
  auth: {
    signIn: 'Iniciar Sesión',
    signInSubtitle: 'Ingresa tu correo para iniciar sesión',
    createAccount: 'Crear Cuenta',
    createAccountSubtitle: 'Ingresa tu correo para comenzar',
    ...
    setupPasskey: 'Configurar Passkey',
    setupPasskeySubtitle: 'Inicia sesión más rápido con una passkey',
  ...
  podcast: {
    ...
    episodeSearchCount:
      '{count} de {total} {total, plural, one {episodio} other {episodios}}',
    sort: 'Orden:',
    sortOptions: {
      releaseDesc: 'Fecha de lanzamiento (Nuevos → Antiguos)',
      releaseAsc: 'Fecha de lanzamiento (Antiguos → Nuevos)',
      titleAsc: 'Título (A → Z)',
      titleDesc: 'Título (Z → A)',
      lengthAsc: 'Duración (Cortos → Largos)',
      lengthDesc: 'Duración (Largos → Cortos)',
    },
