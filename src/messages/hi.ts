...
export const messages: Messages = {
  ...
  auth: {
    signIn: 'साइन इन',
    signInSubtitle: 'साइन इन करने के लिए अपना ईमेल दर्ज करें',
    createAccount: 'खाता बनाएं',
    createAccountSubtitle: 'शुरू करने के लिए अपना ईमेल दर्ज करें',
    ...
    setupPasskey: 'पासकी सेट करें',
    setupPasskeySubtitle: 'पासकी के साथ तेज़ी से साइन इन करें',
