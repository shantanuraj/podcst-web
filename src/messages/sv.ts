...
export const messages: Messages = {
  ...
  auth: {
    signIn: 'Logga in',
    signInSubtitle: 'Ange din e-post för att logga in',
    createAccount: 'Skapa konto',
    createAccountSubtitle: 'Ange din e-post för att komma igång',
    ...
    setupPasskey: 'Ställ in Passkey',
    setupPasskeySubtitle: 'Logga in snabbare med en passkey',
