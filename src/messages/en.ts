export const messages = {
  ...
  auth: {
    signIn: 'Sign In',
    signInSubtitle: 'Enter your email to sign in',
    createAccount: 'Create Account',
    createAccountSubtitle: 'Enter your email to get started',
    ...
    setupPasskeySubtitle: 'Sign in faster next time with a passkey',
