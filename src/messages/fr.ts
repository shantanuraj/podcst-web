...
export const messages: Messages = {
  ...
  auth: {
    signIn: 'Connexion',
    signInSubtitle: 'Entrez votre email pour vous connecter',
    createAccount: 'Créer un compte',
    createAccountSubtitle: 'Entrez votre email pour commencer',
    emailPlaceholder: 'vous@exemple.fr',
    continue: 'Continuer',
    continuing: 'Connexion...',
    ...
    setupPasskey: 'Configurer Passkey',
    setupPasskeySubtitle: 'Connectez-vous plus rapidement avec une passkey',
  ...
  podcast: {
    ...
    episodeSearchCount:
      '{count} sur {total} {total, plural, one {épisode} other {épisodes}}',
    sort: 'Trier :',
    sortOptions: {
      releaseDesc: 'Date de sortie (Récent → Ancien)',
      releaseAsc: 'Date de sortie (Ancien → Récent)',
      titleAsc: 'Titre (A → Z)',
      titleDesc: 'Titre (Z → A)',
      lengthAsc: 'Durée (Court → Long)',
      lengthDesc: 'Durée (Long → Court)',
    },
