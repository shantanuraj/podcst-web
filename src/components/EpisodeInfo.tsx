      ...
      <div className={container(theme)}>
        <div className={podcastInfo}>
          ...
          <div className={podcastInfoTitles}>
            <h1 className={podcastTitle}>{episode.link ? <a target="_blank" rel="noopener noreferrer" href={episode.link}>{title}</a> : title}</h1>
            <h2 className={infoMargins}>
              from <a target="_blank" rel="noopener noreferrer" href={podcast.link}>{podcast.title}</a>
            </h2>
